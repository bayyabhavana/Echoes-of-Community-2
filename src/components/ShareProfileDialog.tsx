...
export default function ShareProfileDialog({
    ...
    const shareText = `Check out ${userName}'s profile on Echoes of Community!`;
    ...
    const handleEmailShare = () => {
        const subject = encodeURIComponent(`${userName}'s Profile`);
                    ...
                    <div className="space-y-2">
                        ...
                        <div className="grid grid-cols-2 gap-2">
                            ...
                            <Button
                                ...
                                variant="outline"
                                className="gap-2 bg-[#1DA1F2] hover:bg-[#1A8CD8] text-white border-0"
                            >
                                <svg className="h-4 w-4" fill="currentColor" viewBox="0 0 24 24">
                            ...
                            <Button
                                ...
                                variant="outline"
                                className="gap-2 bg-[#0A66C2] hover:bg-[#095196] text-white border-0"
                            >
                                <svg className="h-4 w-4" fill="currentColor" viewBox="0 0 24 24">
